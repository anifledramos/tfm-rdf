...
int main(int argc, char* argv[]) {
	...
	for (i = 0; i < numQueries; i++) {
		...
		/* JOIN 1 */
		case 11:
			results = sppo(treps, numPredicados, queriesDat[2][i] - 1, queriesDat[1][i],
					queriesDat[4][i], queriesDat[5][i] - 1, PORSUJETO, PORSUJETO);
			break;
		case 12:
			results = sppoParalelo(treps, numPredicados, queriesDat[2][i] - 1, queriesDat[1][i],
					queriesDat[4][i], queriesDat[5][i] - 1, PORSUJETO, PORSUJETO);
			break;
		case 13:
			results = sppoIzquierda(treps, numPredicados, queriesDat[2][i] - 1, queriesDat[1][i],
					queriesDat[4][i], queriesDat[5][i] - 1, PORSUJETO, PORSUJETO);
			break;
		case 14:
			results = sppoDerecha(treps, numPredicados, queriesDat[2][i] - 1, queriesDat[1][i],
					queriesDat[4][i], queriesDat[5][i] - 1, PORSUJETO, PORSUJETO);
			break;
			...
			/* JOIN 2 */
		case 211:
			results = sp_o(treps, numPredicados, *indiceSP, *indiceOP, queriesDat[2][i] - 1,
					queriesDat[1][i], queriesDat[5][i] - 1, 1, PORSUJETO, PORSUJETO);
			break;
		case 221:
			results = sp_oParalelo(treps, numPredicados, *indiceSP, *indiceOP, queriesDat[2][i] - 1,
					queriesDat[1][i], queriesDat[5][i] - 1, 1, PORSUJETO, PORSUJETO);
			break;
		case 231:
			results = sp_oInterseccion(treps, numPredicados, *indiceSP, *indiceOP,
					queriesDat[2][i] - 1, queriesDat[1][i], queriesDat[5][i] - 1, 1, PORSUJETO,
					PORSUJETO);
			break;
		case 212:
			results = sp_o(treps, numPredicados, *indiceSP, *indiceOP, queriesDat[2][i] - 1,
					queriesDat[1][i], queriesDat[5][i] - 1, 0, PORSUJETO, PORSUJETO);
			break;
		case 222:
			results = sp_oParalelo(treps, numPredicados, *indiceSP, *indiceOP, queriesDat[2][i] - 1,
					queriesDat[1][i], queriesDat[5][i] - 1, 0, PORSUJETO, PORSUJETO);
		...
		case 232:
			results = sp_oInterseccion(treps, numPredicados, *indiceSP, *indiceOP,
					queriesDat[2][i] - 1, queriesDat[1][i], queriesDat[5][i] - 1, 0, PORSUJETO,
					PORSUJETO);
			break;

			/* join 3 */
		case 311:
			results = s__o(treps, numPredicados, *indiceSP, *indiceOP, queriesDat[2][i] - 1,
					queriesDat[5][i] - 1, 1, PORSUJETO, PORSUJETO);
			break;
		case 312:
			results = s__o(treps, numPredicados, *indiceSP, *indiceOP, queriesDat[2][i] - 1,
					queriesDat[5][i] - 1, 0, PORSUJETO, PORSUJETO);
			break;
		case 321:
			results = s__oParalelo(treps, *indiceSP, *indiceOP, numPredicados, queriesDat[2][i] - 1,
					queriesDat[5][i] - 1, 1, PORSUJETO, PORSUJETO);
			break;
		case 322:
			results = s__oParalelo(treps, *indiceSP, *indiceOP, numPredicados, queriesDat[2][i] - 1,
			...
			break;
		case 331:
			results = s__oMerge(treps, numPredicados, *indiceSP, *indiceOP, queriesDat[2][i] - 1,
					queriesDat[5][i] - 1, 1, PORSUJETO, PORSUJETO);
			break;
		case 332:
			results = s__oMerge(treps, numPredicados, *indiceSP, *indiceOP, queriesDat[2][i] - 1,
		...
		case 341:
			results = s__oMergeParalelo(treps, numPredicados, *indiceSP, *indiceOP,
					queriesDat[2][i] - 1, queriesDat[5][i] - 1, 1, PORSUJETO, PORSUJETO);
			break;
		case 342:
			results = s__oMergeParalelo(treps, numPredicados,*indiceSP, *indiceOP,
					queriesDat[2][i] - 1, queriesDat[5][i] - 1, 0, PORSUJETO, PORSUJETO);
			break;
