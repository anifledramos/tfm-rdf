 ...
 *
 */
public class K2TriplesIterator implements IteratorTripleID {
	...
	K2TriplesIterator(TripleID query, int nres, int [] s, int [] p, int [] o) {
		this(query, nres, s, p, o, TripleComponentOrder.Unknown);
	}
	
	K2TriplesIterator(TripleID query, int nres, int [] s, int [] p, int [] o, TripleComponentOrder order) {
		this.query = query;
		this.current = 0;
		this.order = order;
		this.size = nres;
